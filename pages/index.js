    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-accent/10 to-base-100 relative animate-fade-in">
        <header className="container mx-auto px-6 py-12 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-accent transition-colors hover:text-white animate-pulse">
        ...
        <main className="container mx-auto px-6 py-12">
          <section className="text-center">
            <h2 className="text-3xl font-bold text-accent transition-colors hover:text-white animate-pulse">
              Featured Topics
            </h2>
            <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 mt-8 ${styles.featuredGrid}`} style={{ minHeight: '300px' }}>
              <div className="p-6 bg-base-200 rounded-lg shadow-md hover:shadow-lg">
                <h3 className="text-xl font-semibold text-accent transition-colors hover:text-white animate-pulse">Finance</h3>
                <p className="mt-2 text-base-content/70">Insights on investments and economics.</p>
              </div>
              <div className="p-6 bg-base-200 rounded-lg shadow-md hover:shadow-lg">
                <h3 className="text-xl font-semibold text-accent transition-colors hover:text-white animate-pulse">Technology</h3>
              ...
              <div className="p-6 bg-base-200 rounded-lg shadow-md hover:shadow-lg">
                <h3 className="text-xl font-semibold text-accent transition-colors hover:text-white animate-pulse">Ancient civilisations and the outerspace</h3>
                <p className="mt-2 text-base-content/70">Exploring humanity’s origins and our place in the cosmos.</p>
              </div>
            </div>
            <Link
              href="/blog"
              className="mt-8 inline-block btn btn-accent text-accent font-bold transition-colors hover:text-white animate-pulse shadow-lg"
            >
              Visit my blog
            </Link>
          </section>
          ...
          <section id="subscription" className="mt-16 p-8 bg-accent/20 rounded-lg shadow-md">
            <h2 className="text-2xl font-bold text-accent transition-colors hover:text-white animate-pulse text-center">Get in Touch</h2>
            <p className="mt-2 text-center text-base-content/80">Subscription options are available on my <Link href="/contact"><strong>Contact page</strong></Link>.</p>
          </section>
        </main>
